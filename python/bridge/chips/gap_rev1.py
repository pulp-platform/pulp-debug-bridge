...
REF_CLOCK_WAIT_FUSE_OFFSET = 52
FLASH_ID_FUSE_OFFSET = 54

USER_FUSE_OFFSET = 56
USER_FUSE_SIZE = 128 - USER_FUSE_OFFSET
...
def hex_fuse(offset, len=1, danger=True, writable=True):
    return {
        "fuse_offset": offset * 8,
        "bit_len": 8 * len,
        "format": "hex",
        "writable": writable,
        "danger": danger
...
FUSES = {
    ...
    "WAIT_CYCLES": {
        "fuse_offset": WAIT_CYCLES_FUSE_OFFSET * 8,
        "bit_len": 2 * 8,
        "format": "hex",
        "writable": True,
        "danger": True
    ...
    "INFO3": {
        "fuse_offset": INFO3_FUSE_OFFSET * 8,
        "bit_len": 8,
        "format": "binary",
        "writable": False
    },
    "FLASH_TYPE": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 7, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "SET_SPIM_CLK_DIV": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 6, # Offset is from bit 7 in all cases
        "bit_len": 2,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "FLASH_RESET": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 5, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "SET_FLASH_WAIT": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 4, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "FLASH_WAKEUP": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 3, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "FLASH_INIT": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 2, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "FLASH_RESET_WAIT": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 1, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "SET_REF_CLOCK_WAIT": {
        "fuse_offset": (INFO3_FUSE_OFFSET * 8) + 0, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "INFO4": {
        "fuse_offset": INFO4_FUSE_OFFSET * 8,
        "bit_len": 8,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "INFO5": {
        "fuse_offset": INFO5_FUSE_OFFSET * 8,
        "bit_len": 8,
        "format": "binary",
        "writable": False,
    },
    "FLASH_CHIP_SELECT": {
        "fuse_offset": (INFO5_FUSE_OFFSET * 8) + 7, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "FLASH_INTERFACE_ID": {
        "fuse_offset": (INFO5_FUSE_OFFSET * 8) + 6, # Offset is from bit 7 in all cases
        "bit_len": 2,
        "format": "hex",
        "writable": True,
        "danger": True
    ...
    "FLASH_PAD_CONFIG": {
        "fuse_offset": (INFO5_FUSE_OFFSET * 8) + 4, # Offset is from bit 7 in all cases
        "bit_len": 2,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "HYPER_CHIP_SIZE": {
        "fuse_offset": (INFO5_FUSE_OFFSET * 8) + 2, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "HYPER_DELAY": {
        "fuse_offset": (INFO5_FUSE_OFFSET * 8) + 1, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "HYPER_LATENCY": {
        "fuse_offset": (INFO5_FUSE_OFFSET * 8) + 0, # Offset is from bit 7 in all cases
        "bit_len": 1,
        "format": "binary",
        "writable": True,
        "danger": True
    ...
    "INFO6": {
        "fuse_offset": INFO6_FUSE_OFFSET * 8,
        "bit_len": 8,
        "format": "hex",
        "writable": True,
        "danger": True
    },
    "FLASH_CMD": hex_fuse(FLASH_CMD_FUSE_OFFSET),
    "FLASH_CMD2": hex_fuse(FLASH_CMD2_FUSE_OFFSET),
    "FLASH_CMD3": hex_fuse(FLASH_CMD3_FUSE_OFFSET),
    "FLASH_CMD4": hex_fuse(FLASH_CMD4_FUSE_OFFSET),
    "FLASH_WAIT": hex_fuse(FLASH_WAIT_FUSE_OFFSET),
    "HYPERCHIP_SIZE": hex_fuse(HYPERCHIP_SIZE_FUSE_OFFSET),
    "I2C_DIV": hex_fuse(I2C_DIV_FUSE_OFFSET, len=2),
    "I2C_CS": hex_fuse(I2C_DIV_FUSE_OFFSET),
    "FLASH_RESET_WAIT": hex_fuse(I2C_DIV_FUSE_OFFSET),
    "HYPER_LATENCY": hex_fuse(I2C_DIV_FUSE_OFFSET),
    "REF_CLOCK_WAIT": hex_fuse(REF_CLOCK_WAIT_FUSE_OFFSET, len=2),
    "FLASH_ID": hex_fuse(FLASH_ID_FUSE_OFFSET, len=2),
}
